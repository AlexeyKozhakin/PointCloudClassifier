...
input_dir = r'/mnt/working-ssd/alexey_kozhakin/MUSAC/data/STPLS3D/ml_data_training/cut_test_32_csv'  # Замените на путь к вашему каталогу
output_file = r'D:\data\las_org\\dataset.npy'  # Замените на путь для итогового файла
